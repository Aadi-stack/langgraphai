...
import uvicorn  # Import Uvicorn server for runni   ng the FastAPI app


# Retrieve and set API keys for external tools and services
groq_api_key = os.getenv("GROQ_API_KEY", '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')  # Groq API key
os.environ["TAVILY_API_KEY"] = os.getenv("TAVILY_API_KEY", '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')  # Set Tavily API key
